...
import com.ordering.system.order.service.domain.core.OrderDomainServiceImpl;
...
@SpringBootApplication(scanBasePackages = "com.ordering.system.order", exclude = {DataSourceAutoConfiguration.class})
